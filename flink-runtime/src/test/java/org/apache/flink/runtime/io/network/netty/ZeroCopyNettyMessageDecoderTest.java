...
public class ZeroCopyNettyMessageDecoderTest {
	...
	private CreditBasedPartitionRequestClientHandler createPartitionRequestClientHandler(int numberOfBuffersInNormalChannel) throws Exception {
		...
		final RemoteInputChannel normalInputChannel = spy(InputChannelBuilder.newBuilder()
		...
		final RemoteInputChannel releasedInputChannel = spy(InputChannelBuilder.newBuilder()
			.setMemorySegmentProvider(networkBufferPool)
			.buildRemoteAndSetToGate(inputGate));
