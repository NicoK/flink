 ...
 */
public final class ReadOnlyDuplicateNetworkBuffer extends DuplicatedByteBuf implements Buffer{
	 ...
	 */
	ReadOnlyDuplicateNetworkBuffer(NetworkBuffer buffer) {
		super(buffer);
	}
	...
	@Override
	public ReadOnlyDuplicateNetworkBuffer duplicate() {
		ReadOnlyDuplicateNetworkBuffer duplicatedBuffer = new ReadOnlyDuplicateNetworkBuffer(unwrap());
	...
	@Override
	public ReadOnlyDuplicateNetworkBuffer retainBuffer() {
		unwrap().retainBuffer();
		return this;
	}
